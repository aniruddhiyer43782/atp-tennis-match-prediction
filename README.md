...
Current best model by ROC-AUC: Calibrated Random Forest.
...
The strongest baseline signals by calibrated Random Forest feature importance are:

1. Ranking points difference
2. Overall Elo difference
3. Ranking difference
4. Surface-specific Elo difference
5. Recent serve dominance difference
6. Surface form difference
